...
DATASET = r"C:\Users\somavarapu lokesh\PycharmProjects\placement_prediction\dataset\final_preprocess_M2.csv"

OUTPUT_FOLDER = r"C:\Users\somavarapu lokesh\PycharmProjects\placement_prediction\outputs\Logistic_Regression_Binary_Classify_M2"
...
# PlacementStatus was standardized in preprocessing.
# Convert it back to binary classification:
#
# -1.384367 -> 0 = Not Placed
#  0.722352 -> 1 = Placed

y = (y > 0).astype(int)

# Binary target used for plotting
df["PlacementStatus_Binary"] = y
...
# ============================================================
# 18. CREATE CGPA-HISTORY OF BACKLOGS GRID
# ============================================================
