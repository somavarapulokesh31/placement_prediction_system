...
OUTPUT_FOLDER = (
    r"C:\Users\somavarapu lokesh\PycharmProjects\placement_prediction"
    r"\outputs\Decision_Tree_Classifier_M3_Outputs"
)
...
# ================================================================
# 46. DECISION TREE DISPLAY
# ================================================================
#
# IMPORTANT:
# plt.show() was removed intentionally.
#
# The image is already saved above.
# Removing plt.show() prevents PyCharm/Matplotlib
# from terminating or blocking the process.
#
# ================================================================
...
print(
    "\nSaving Decision Tree parameters..."
)
...
print(
    "Decision Tree parameters saved:",
    parameters_path
)
